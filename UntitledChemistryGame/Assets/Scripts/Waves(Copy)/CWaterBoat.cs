...
public class CWaterBoat : MonoBehaviour
{
    //visible Properties
    ...
    public void FixedUpdate()
    {
        ...
        transform.Rotate(_rotation * SteerPower * Time.deltaTime);

        //_velocity = Rigidbody.velocity.magnitude;
        //_vectorVelocity = Rigidbody.velocity;


        //Rotational Force
        //var dragCoeff = 1 + Drag;

        //Rigidbody.AddForceAtPosition(_rotation * transform.right * Time.deltaTime * SteerPower, Motor.position);
